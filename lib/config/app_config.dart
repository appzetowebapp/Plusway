...
class AppConfig {
  // ==================== APP IDENTITY ====================
  static const String appName = 'Plusway';
  ...
  static const String webUrl = 'https://plusway.in';
  ...
  static const String apiBaseUrl = 'https://plusway.in/api';
  static const String fcmTokenUrl =
      'https://plusway.in/api/fcm-tokens/save';
